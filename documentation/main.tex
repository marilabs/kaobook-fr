%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% kaobook - updates by me (Marilou de Courville)
% LaTeX Class
...
\author[Federico Marotta, with additions by Marilou de Courville]{Federico Marotta\thanks{A \LaTeX\ lover}, with additions by Marilou de Courville}
...
\addpart{Tronc commun}
\pagelayout{margin} % Restore margins

\input{chapters/cip.tex}
\input{chapters/edp.tex}
\input{chapters/stat.tex}
\input{chapters/model.tex}

\input{chapters/sip.tex}
\input{chapters/algo-compl.tex}

\input{chapters/phy-q-stat.tex}
\input{chapters/tds.tex}

\input{chapters/finance.tex}
\input{chapters/gestion.tex}
\input{chapters/APIPO.tex}
...
\input{chapters/reseaux-sec.tex}
\input{chapters/syst-elec.tex}
